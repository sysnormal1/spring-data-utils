package com.sysnormal.commons.spring.spring_data_utils.migration.oracle;
...
/**
 * implementation of base creation table statement for oracle database
 *
 * @author Alencar
 * @version 1.0.0
 */
public class OracleCreationTableStatement extends BaseCreationTableStatement {

    private static final Logger logger = LoggerFactory.getLogger(OracleCreationTableStatement.class);

    public OracleCreationTableStatement(PersistentClass persistentEntity, Metadata metadata) {
                ...
                if (columnAnotation != null) {
                    ...
                    if (generatedValue != null) {
                        if (generatedValue.strategy().compareTo(GenerationType.IDENTITY) == 0) {
                            columnStatement = checkColumnStatmentContainsOrAdd(columnStatement, columnDefinition, "GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE");
                        }
                    }
